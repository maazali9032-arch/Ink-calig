...
## Ink & Calligraphy Formation




Core identity: the invitation is written into existence by flowing ink and calligraphic strokes.
...
- Ink strokes physically travel along paths.

- Names are drawn stroke-by-stroke.

- Decorative flourishes branch naturally from the writing.

- Secondary ornaments appear as brush/pen gestures.

- Use SVG stroke drawing/pathLength and Motion.

- The finished word must be the consequence of the animated stroke, not a text fade.
...
A quiet paper/ink surface with a tiny ink origin or first brush movement.
...
Groom name is written, then the ampersand/connector, then bride name. Preserve the required three-line hierarchy even if the lettering is calligraphic.
...
ink introduction → names → date → invitation message → family/relatives → events → venue → gallery → RSVP → final calligraphic flourish.
...
Warm paper/ivory, black or deep sepia ink, restrained muted gold accent.




Support multilingual/Unicode text where returned by the platform. Do not hardcode Arabic/Urdu/Hindi content as production data.
...
This is ink formation, not handwriting-like fade animation. Do not turn it into generic typography or a henna design.
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/8e13b3bf-0e97-454e-b84d-9789338e0439).
